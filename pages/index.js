  ...
  return (
    <>
      ...
      <main id="MainPage">
        <Modal
          ...
          <div className='bg-[#1e1e1e] min-h-screen'>
            ...
            <div className='embed-container p-0 flex items-center justify-center'>
              <iframe width="1440" height="810" src="https://www.youtube-nocookie.com/embed/B0J46O-uEvs?controls=0" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
            </div>
        ...
        <section className='intro max-w-screen flex justify-center relative'>          
          <div className="marquee">
          <Image
                  src="/scritta-shurike.png"
                  alt="Shuriken in ear"
                  width={3650}
                  height={588}                  
                />
          ...
          <div className='text-center text-[2.2vw] absolute h-full flex item-center pt-[13.6%] gap-2 -z-10 items-center pl-10 indusrty-light'>
            <span className='industry-bold'>HEAR</span>
            <span>YOUR</span>
            <span className='industry-bold'>ENEMY</span>
          </div>
        </section>
        <section className='flex bg-video p-60 bg-white cursor-pointer' onClick={ () => {  setIsOpen(true) } }></section>       
        <section className='intro-shuriken grid grid-cols-2 gap-4 px-44 py-20 '>
          ...
          <div>
            <div className='section-title uppercase text-[36px] indusrty-light'>
              The <span className='industry-bold'>next gen</span> earphones
            </div>
            <div className='content-section text-[24px] leading-[28px]'>
              <p>
        ...
        <section className='model-shuriken grid grid-cols-2 gap-4 px-44 py-20 '>
          <div>
            <model-viewer src="/in_ear.glb" disable-zoom disable-pan camera-orbit="0 100deg" alt="Shuriken headset" auto-rotate camera-controls></model-viewer>
          </div>
          <div>
            <div className='section-title uppercase text-[36px] mb-10 indusrty-light'>
              <span className='industry-bold'>Specifiche</span> Tecniche
            </div>
            <div className='content-section text-[24px] leading-[28px]'>
              <p>2x Driver Balanced Armature (per cuffia)</p>
              <p>Impedenza 60Ω</p>
        ...
        <section className='section-nts grid grid-cols-2 gap-4 px-44 py-20 '>
          <div className='text-right'>
              ...
              /> 
            <div className='section-title text-[36px] leading-[1] mb-10 text-right'>
              <p className='industry-bold uppercase'>Ottimizato per il gaming</p>
              <p className='indusrty-light'>da fonici NTS Audio</p>
            </div>
            <div className='content-section text-[24px] leading-[28px] text-right'>
              <p>
              Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. 
              </p>
              <p>
        ...
        <Swiper
                    ...
                    simulateTouch={false}
                    modules={[Autoplay]}
                    autoplay={{delay:0,disableOnInteraction:false}}speed={20000}>            
              <SwiperSlide>
          ...
          <div className='text-center p-10'><span className='uppercase text-[#4B4B4B]'>Accessori e Upgrade acquistabili separatamente</span></div>
        </section>
        <section className='min-h-screen p-10 section-kunai-software'>
            <div className='flex h-screen justify-center items-center'>
              <div className='text-center'>
                ...
                />
                <div className='text-[48px] industry-bold uppercase leading-[1]'>Kunai Eq Software</div>
                <div className='text-[#4B4B4B] text-[48px] leading-[1] indusrty-light'>upcoming in 2023</div>
              </div>
            </div>
        </section>
        <footer>
          <div className='flex p-10 justify-center items-center'>
              <a href='https://unloaded.gg' title='Unloaded' target='_blank' rel='noopener nofollow'>
